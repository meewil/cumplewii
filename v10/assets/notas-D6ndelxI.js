import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DRdy2sPR.js";import{a as n,d as r,i,w as a}from"./widev-UCf0wkdW.js";import{n as o}from"./index-B-mbTFJY.js";import{M as s,O as c,S as l,T as u,_ as d,k as f,m as p,v as m,x as h}from"./firebase-37FTGmWc.js";import{n as g,t as _}from"./firebase-83wos_3H.js";var v=[],y=null,b=null,x=null,S=`wi_notas_cache`,C=`wi_notas_cache_time`,w=100,T=1200,E=300*1e3,D=()=>r(`wiSmile`)||{},O=e=>{try{localStorage.setItem(S,JSON.stringify(e)),localStorage.setItem(C,Date.now().toString())}catch{}},k=()=>{try{return JSON.parse(localStorage.getItem(S)||`[]`)}catch{return[]}},A=()=>{let e=parseInt(localStorage.getItem(C)||`0`);return Date.now()-e<E},j=()=>{localStorage.removeItem(S),localStorage.removeItem(C)},M=[{id:`Cielo`,hex:`#0EBEFF`,bg:`rgba(14,190,255,.12)`,tx:`var(--tx)`,rgb:`14,190,255`},{id:`Dulce`,hex:`#FF5C93`,bg:`rgba(255,92,147,.12)`,tx:`var(--tx)`,rgb:`255,92,147`},{id:`Paz`,hex:`#10B981`,bg:`rgba(16,185,129,.12)`,tx:`var(--tx)`,rgb:`16,185,129`},{id:`Mora`,hex:`#8B5CF6`,bg:`rgba(139,92,246,.12)`,tx:`var(--tx)`,rgb:`139,92,246`},{id:`Sol`,hex:`#F59E0B`,bg:`rgba(245,158,11,.12)`,tx:`var(--tx)`,rgb:`245,158,11`}],N=()=>{let e=D();if(!e.email)return location.replace(`/`),``;let r=e.nombre||e.usuario||e.email||_.currentUser?.email||``;return`
