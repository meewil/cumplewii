import{n as e}from"./vendor-BBPjS4yS.js";import{d as t,i as n,m as r,n as i,p as a,t as o}from"./widev-UCf0wkdW.js";import"./index-B-mbTFJY.js";import{M as s,O as c,_ as l,k as u,w as d}from"./firebase-37FTGmWc.js";import{n as f}from"./firebase-83wos_3H.js";var p=[],m=`todos`,h=``,g=null,_=!1,v=`rrhhUsuarios`,y=30,b=e=>((e.nombre||``)+` `+(e.apellidos||``)||e.usuario||`?`).trim().split(/\s+/).slice(0,2).map(e=>(e[0]||``).toUpperCase()).join(``),x=(e,t=40)=>{if(e.imagen)return`<div class="rrhh_avatar" style="width:${t}px;height:${t}px"><img src="${e.imagen}" alt="${o(e.nombre||e.usuario||`?`)}" loading="lazy"/></div>`;let n=b(e);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${e.rol||`smile`}" style="width:${t}px;height:${t}px;font-size:${Math.round(t*.36)}px">${n}</div>`},S=e=>{let t=(e||`smile`).toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${t}">${o(t)}</span>`},C=(e,t)=>{let n=t===`activo`;return`
