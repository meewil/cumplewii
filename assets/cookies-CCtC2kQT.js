...
</div></main>`,s=null,c=()=>{s=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&n(e.target).addClass(`visible`)}),{threshold:.1}),n(`.wi_fadeUp`).each(function(){s.observe(this)}),n(document).on(`click.cookies`,`.tm_nav`,function(e){e.preventDefault(),r(()=>import(`./index-D0682O7w.js`).then(e=>e.rutas.navigate(n(this).attr(`href`))),[])}),console.log(`🍪 ${e} Cookies cargada`),window.__WIREADY__=!0},l=()=>{s?.disconnect?.(),s=null,n(document).off(`.cookies`)};export{l as cleanup,c as init,o as render};