import{t as e}from"./wii-DFanSMW3.js";import{E as t,b as n,o as r}from"./widev-Czq8ue36.js";import{n as i}from"./vendor-Dkcx8wGc.js";import{E as a,S as o,g as s,k as c}from"./firebase-BY5GISzq.js";import{n as l}from"./firebase-BOoMX3kr.js";var u=()=>n(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let t=u();return!t||t.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let e=u();!e||e.rol!==`admin`||(i(document).off(`.am`),v(),y(),i(document).on(`click.am`,`#am_btn_refresh`,function(){let e=i(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>e.removeClass(`fa-spin`),500)})}))},_=()=>{i(document).off(`.am`)};function v(){i(`#am_n_total`).text(n(d)||`—`),i(`#am_n_pro`).text(n(f)||`—`),i(`#am_n_org`).text(n(p)||`—`),i(`#am_n_les`).text(n(m)||`45`)}async function y(e=!1){try{let u=c(l,`smiles`);if(e||!n(d)){let e=(await s(u)).data().count;t(d,e),i(`#am_n_total`).text(e)}if(e||!n(f)){let e=(await s(o(u,a(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;t(f,e),i(`#am_n_pro`).text(e)}if(e||!n(p)){let e=(await s(o(u,a(`rol`,`==`,`empresa`)))).data().count;t(p,e),i(`#am_n_org`).text(e)}e&&r(`Estadísticas sincronizadas`,`success`)}catch(t){console.error(`[Admin] Error cargando stats:`,t),e&&r(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};