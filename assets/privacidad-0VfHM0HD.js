...
`,o=null,s=()=>{o=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&n(e.target).addClass(`visible`)}),{threshold:.1}),n(`.wi_fadeUp`).each(function(){o.observe(this)}),n(document).on(`click.privacidad`,`.tm_nav`,function(e){e.preventDefault(),r(()=>import(`./index-D0682O7w.js`).then(e=>e.rutas.navigate(n(this).attr(`href`))),[])}),n(document).on(`click.privacidad`,`.tm_index_item`,function(e){e.preventDefault();let t=document.querySelector(n(this).attr(`href`));t&&window.scrollTo({top:t.getBoundingClientRect().top+scrollY-90,behavior:`smooth`})}),console.log(`🔒 ${e} Privacidad cargada`),window.__WIREADY__=!0},c=()=>{o?.disconnect?.(),o=null,n(document).off(`.privacidad`)};export{c as cleanup,s as init,a as render};