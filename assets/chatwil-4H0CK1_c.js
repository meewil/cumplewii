import{n as e}from"./vendor-BBPjS4yS.js";import{a as t}from"./widev-BDGuiI8Y.js";import{r as n}from"./index-CY2wNeZs.js";import{SUGERENCIAS as r,detectarTema as i}from"./contexto-L3EVOZU7.js";import"./waa-BSRlNFQl.js";var a=()=>{let e=r.general,n=t().replace(/, $/,``).toLowerCase();return`
<div class="miia">
...
</div>`},o=!1,s=0,c=null,l=[],u=()=>({$msg:e(`#miiaMessages`),$inp:e(`#miiaInput`),$btn:e(`#miiaSend`)}),d=(t=!1)=>{let n=e(`.miia_messages_wrap`)[0];n&&(t?n.scrollTo({top:n.scrollHeight,behavior:`smooth`}):n.scrollTop=n.scrollHeight)},f=async()=>c??=await n(()=>import(`./brain-Doqafghp.js`),[]),p=e=>e.replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br>`).replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`).replace(/\*(.*?)\*/g,`<strong>$1</strong>`),m=(t,n)=>{let{$msg:r}=u(),i=new Date().toLocaleTimeString(`es-PE`,{hour:`2-digit`,minute:`2-digit`}),a=e(`
