import{s as e}from"./widev-Czq8ue36.js";import{n as t}from"./vendor-Dkcx8wGc.js";import{r as n}from"./index-U_klNYw1.js";import{SUGERENCIAS as r,detectarTema as i}from"./contexto-DjOqn76q.js";import"./waa-CsZ9R11p.js";var a=()=>{let t=r.general,n=e().replace(/, $/,``).toLowerCase();return`
<div class="miia">
...
</div>`},o=!1,s=0,c=null,l=[],u=()=>({$msg:t(`#miiaMessages`),$inp:t(`#miiaInput`),$btn:t(`#miiaSend`)}),d=(e=!1)=>{let n=t(`.miia_messages_wrap`)[0];n&&(e?n.scrollTo({top:n.scrollHeight,behavior:`smooth`}):n.scrollTop=n.scrollHeight)},f=async()=>c??=await n(()=>import(`./brain-Dvxj6NS3.js`),[]),p=e=>e.replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br>`).replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`).replace(/\*(.*?)\*/g,`<strong>$1</strong>`),m=(e,n)=>{let{$msg:r}=u(),i=new Date().toLocaleTimeString(`es-PE`,{hour:`2-digit`,minute:`2-digit`}),a=t(`
