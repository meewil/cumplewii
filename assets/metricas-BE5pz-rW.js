import{b as e}from"./widev-Czq8ue36.js";import{E as t,S as n,k as r,v as i}from"./firebase-BY5GISzq.js";import{n as a}from"./firebase-BOoMX3kr.js";var o=async()=>`
  ...
  `,s=async()=>{let o=e(`wiSmile`);if(o)try{let e=await i(n(r(a,`linkwiis`),t(`usuario`,`==`,o.usuario))),s=0,c=0,l=[];e.forEach(e=>{let t=e.data(),n=t.vistas||0,r=t.links?t.links.filter(e=>e.url||e.titulo).length:0;s+=n,c+=r,l.push({slug:e.id,vistas:n,linksCount:r,logo:t.logo})}),l.sort((e,t)=>t.vistas-e.vistas);let u=`
