import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DRdy2sPR.js";import{d as n,i as r,m as i}from"./widev-BDGuiI8Y.js";import{O as a,T as o,h as s,x as c}from"./firebase-37FTGmWc.js";import{n as l}from"./firebase-83wos_3H.js";var u=()=>n(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
