...
</div></main>`,s=null,c=()=>{s=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)}),{threshold:.1}),e(`.wi_fadeUp`).each(function(){s.observe(this)}),e(document).on(`click.cookies`,`.tm_nav`,function(t){t.preventDefault(),r(()=>import(`./index-CY2wNeZs.js`).then(t=>t.rutas.navigate(e(this).attr(`href`))),[])}),console.log(`🍪 ${t} Cookies cargada`),window.__WIREADY__=!0},l=()=>{s?.disconnect?.(),s=null,e(document).off(`.cookies`)};export{l as cleanup,c as init,o as render};