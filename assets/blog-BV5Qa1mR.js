import{B as e,C as t,b as n,o as r}from"./widev-Czq8ue36.js";import{n as i}from"./vendor-Dkcx8wGc.js";import{r as a}from"./index-U_klNYw1.js";import{_ as o,a as s,d as c,g as l,h as u,i as d,l as f}from"./devblog-CBj5FplG.js";var p=16,m=8,h=[{id:`nuevo`,icon:`fa-clock`,label:`Recientes`},{id:`vistas`,icon:`fa-fire`,label:`Populares`}],g=t=>{let n=d(t.categoria);return`
  <a href="/${t.slug||t.id}" class="bl_card">
    <div class="bl_card_img">
      <img src="${t.imagen||`https://placehold.co/600x400?text=📖`}" alt="${t.imagenAlt||t.titulo}" loading="lazy" onerror="this.src='https://placehold.co/600x400?text=📖'"/>
      <div class="bl_card_over">
        <span class="bl_card_cat" style="--cc:${n.color}"><i class="fas ${n.icon}"></i> ${t.categoria||`—`}</span>
        ${t.pin?`<span class="bl_card_dest" ${e(`Destacada`)}><i class="fas fa-thumbtack"></i></span>`:``}
      </div>
    </div>
    <div class="bl_card_body">
      <h2 class="bl_card_tit">${t.titulo}</h2>
      <p class="bl_card_res">${t.resumen||``}</p>
      <div class="bl_card_footer">
        <div class="bl_card_meta">
          <span ${e(`Tiempo`)}><i class="fas fa-clock"></i> ${t.tiempoLectura||`—`}</span>
          <span ${e(`Vistas`)}><i class="fas fa-eye"></i> ${t.vistas||0}</span>
          <span ${e(`Likes`)}><i class="fas fa-heart" style="color:#fe0149"></i> ${t.likes||0}</span>
        </div>
  ...
  <div class="bl_wrap">
    ...
    <div class="bl_bar">
      ...
      <div class="bl_bar_right">
        ...
        <button class="bl_icon_btn" id="bl_search_toggle" ${e(`Buscar`)}><i class="fas fa-search"></i></button>
        <button class="bl_icon_btn" id="bl_refresh" ${e(`Actualizar`)}><i class="fas fa-rotate"></i></button>
      </div>
    </div>
