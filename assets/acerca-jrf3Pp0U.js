import{n as e,t}from"./wii-DFanSMW3.js";import{U as n}from"./widev-BKJDWmod.js";import{n as r}from"./vendor-Dkcx8wGc.js";import{a as i}from"./index-D0682O7w.js";var a=()=>`
<main id="wimain">
<div class="ac_wrap">
...
`,o=()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&r(e.target).addClass(`visible`)})},{threshold:.1});r(`.wi_fadeUp`).each(function(){e.observe(this)}),r(`#ac_compartir`).on(`click`,function(){let e=window.location.origin;navigator.share?navigator.share({title:t,text:`🎉 Organiza tus cumpleaños y celebraciones de forma veloz, segura y premium con ${t}. ¡Pruébalo!`,url:e}).catch(()=>{}):n(e,this,`¡Link copiado!`)}),r(document).on(`click.acerca`,`.nv_item`,function(e){let t=r(this).attr(`href`);t&&t.startsWith(`/`)&&(e.preventDefault(),i(()=>import(`./index-D0682O7w.js`).then(e=>e.rutas.navigate(t)),[]))}),window.wiInitTips&&window.wiInitTips(),console.log(`🛡️ ${t} Acerca actualizado`),window.__WIREADY__=!0},s=()=>{r(`#ac_compartir`).off(`click`),r(document).off(`.acerca`)};export{s as cleanup,o as init,a as render};