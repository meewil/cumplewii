import{B as e,L as t,b as n,o as r}from"./widev-Czq8ue36.js";import{n as i}from"./vendor-Dkcx8wGc.js";import"./index-U_klNYw1.js";import{A as a,D as o,E as s,N as c,S as l,h as u,k as d,v as f,y as p}from"./firebase-BY5GISzq.js";import{n as m}from"./firebase-BOoMX3kr.js";var h=[],g=null,_=``,v=!0,y=!1,b=null,x=`wiWin`,S=`wi_win_cache`,C=()=>n(`wiSmile`)||{},w=e=>localStorage.setItem(S,JSON.stringify(e)),T=()=>JSON.parse(localStorage.getItem(S)||`[]`),E=()=>h.sort((e,t)=>!!t.pin-+!!e.pin||(t.fechaActualizado?.seconds||0)-(e.fechaActualizado?.seconds||0)),D=()=>({seconds:Math.floor(Date.now()/1e3)}),O=async(e,t=!1)=>{if(y=!e?.email,y){v=!1,k();return}t||i(`.es_btn_refresh`).addClass(`syncing`);try{h=(await f(l(d(m,x),s(`email`,`==`,e.email),p(100)))).docs.map(e=>({_fsId:e.id,...e.data()})),E(),w(h),v=!1,k()}catch{v=!1,t||L()}finally{i(`.es_btn_refresh`).removeClass(`syncing`)}},k=()=>{g||=h.find(e=>e.pin)||h[0]||null,L()},A=async(e=!1)=>{if(!g)return;let n=C(),s=i(`#btnS2`),l=i(`.es_in_title_h`).val().trim()||`Untitled`,u=i(`.es_editor`).html();g.titulo=l,g.contenido=u,g._dirty&&(g.fechaActualizado=D());let d=h.filter(e=>e._dirty);if(!d.length){e&&r(`Sin cambios por guardar`,`info`,800);return}if(w(h),e&&t(s,!0,`Guardando`),y){d.forEach(e=>e._dirty=!1),w(h),F(),e&&setTimeout(()=>{t(s,!1,`Guardado`),setTimeout(()=>s.html(`<i class="fas fa-save"></i> <span id="iconSync">Guardar</span>`),1500)},600);return}try{let i=o(m);for(let e of d){let t={id:e.id,titulo:e.titulo||`Untitled`,contenido:e.contenido||``,email:n.email,usuario:n.usuario||`Public`,fecha:e.fecha||c(),fechaActualizado:c(),pin:!!e.pin};i.set(a(m,x,e._fsId),t),e._dirty=!1}await i.commit(),w(h),F(),e&&(r(`Sincronización Exitosa ✨`,`success`,800),t(s,!1,`Guardado`))}catch(n){e&&(console.error(`Save Error:`,n),r(`Error al guardar`,`error`),t(s,!1,`Reintentar`))}finally{e&&setTimeout(()=>{i(`#btnS2`).length&&i(`#btnS2`).html(`<i class="fas fa-save"></i> <span>Guardar</span>`)},2e3)}},j=async()=>{let e=C(),t=`win${Date.now()}`,n=D(),r={_fsId:t,id:t,titulo:``,contenido:``,pin:!1,email:e.email||`guest`,usuario:e.usuario||`Public`,fecha:n,fechaActualizado:n,_dirty:!0};h.unshift(r),g=r,w(h),L(),i(`.es_in_title_h`).focus(),i(`.es_container`).removeClass(`menu-open`)},M=async(e,n=null)=>{if(confirm(`¿Eliminar?`)){n&&t(i(n),!0,`...`);try{h=h.filter(t=>t._fsId!==e),g?._fsId===e&&(g=h[0]||null),w(h),y||await u(a(m,x,e)),L()}catch{n&&t(i(n),!1,`<i class="fas fa-trash-alt"></i>`),r(`Error al eliminar`,`error`)}}},N=async e=>{let t=h.find(t=>t._fsId===e);t&&(t.pin=!t.pin,t._dirty=!0,t.fechaActualizado=D(),E(),w(h),L())},P=()=>{i(`.es_tool_btn[data-cmd]`).each(function(){let e=i(this).data(`cmd`);try{document.queryCommandState(e)?i(this).addClass(`active`):i(this).removeClass(`active`)}catch{}});try{let e=window.getSelection().anchorNode;if(e){let t=e.nodeType===3?e.parentNode:e;if(i(t).closest(`.es_editor`).length){let e=window.getComputedStyle(t);if(e.fontSize&&i(`#winFontSize`).val(parseInt(e.fontSize)),e.fontFamily){let t=e.fontFamily.split(`,`)[0].replace(/['"]/g,``);i(`#winFontFamily option`).each(function(){(i(this).text()===t||i(this).val().includes(t))&&i(`#winFontFamily`).val(i(this).val())})}let n=i(t).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);if(n.length){let t=n[0].style.lineHeight;t&&i(`#winLineHeight`).val(t),n[0].style.marginBottom===`0px`||e.marginBottom===`0px`?i(`#btnNoMargin`).addClass(`active`):i(`#btnNoMargin`).removeClass(`active`)}}}}catch{}},F=()=>{let t=h.filter(e=>(e.titulo||``).toLowerCase().includes(_.toLowerCase()));i(`.es_list_items_final`).html(t.map(t=>{let n=t.titulo||`Untitled`,r=i(`<div>`).html(t.contenido||``).text().trim()||`Sin contenido...`,a=r.length>30?r.substring(0,30)+`...`:r,o=!t._dirty,s=new Date((t.fechaActualizado?.seconds||Date.now()/1e3)*1e3).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`});return`
        <div class="es_item_final ${g?._fsId===t._fsId?`active`:``}" data-id="${t._fsId}">
            <div class="it_r1">
                ...
                <div class="it_icons">
                    <span class="it_status" ${e(o?`Guardado`:`Pendiente`)}>
                        ${o?`<i class="fas fa-cloud"></i>`:`<i class="fas fa-sync-alt fa-spin" style="color:var(--warning)"></i>`}
                    </span>
                    <i class="fas fa-thumbtack it_action btnPin" data-id="${t._fsId}" style="${t.pin?`color:var(--mco)`:``}" ${e(t.pin?`Desanclar`:`Anclar`)}></i>
                    <i class="fas fa-trash-alt it_action btnDel" data-id="${t._fsId}" ${e(`Borrar`)}></i>
                </div>
            </div>
            <div class="it_r2">
        ...
        <div class="es_page">
            <div class="es_page_header">
                ...
                <div class="es_header_right">
                    ...
                    <button class="es_btn_pro del" id="btnD2" ${e(`Eliminar permanentemente`)}><i class="fas fa-trash-alt"></i> <span>Eliminar</span></button>
                    <button class="es_btn_menu" id="toggleMenu" ${e(`Historial`)}><i class="fas fa-history"></i></button>
                </div>
            </div>
            ...
            <div class="es_page_footer">
                <div class="es_footer_group">
                    ...
                    <button class="es_tool_btn" data-cmd="${t}" ${e(t)}><i class="fas fa-${t===`bold`?`bold`:t===`italic`?`italic`:t===`underline`?`underline`:`strikethrough`}"></i></button>
                    `).join(``)}
                </div>
                <div class="es_footer_sep"></div>
                <div class="es_footer_group">
                    ${[`justifyLeft`,`justifyCenter`,`justifyRight`,`justifyFull`].map(t=>`
                    <button class="es_tool_btn" data-cmd="${t}" ${e(t)}><i class="fas fa-align-${t===`justifyLeft`?`left`:t===`justifyCenter`?`center`:t===`justifyRight`?`right`:`justify`}"></i></button>
                    `).join(``)}
                </div>
                <div class="es_footer_sep"></div>
                <div class="es_footer_group">
                    <button class="es_tool_btn" data-cmd="insertUnorderedList" ${e(`Lista`)}><i class="fas fa-list-ul"></i></button>
                    <button class="es_tool_btn" data-cmd="insertOrderedList" ${e(`Numerada`)}><i class="fas fa-list-ol"></i></button>
                </div>
                <div class="es_footer_sep"></div>
                <div class="es_footer_group">
        ...
        <div class="es_right">
            <div class="es_sidebar_final">
                <div class="es_sidebar_actions">
                    ...
                    <button class="es_btn_refresh" id="btnSync" ${e(`Sync Firestore`)}><i class="fas fa-sync-alt"></i></button>
                </div>
