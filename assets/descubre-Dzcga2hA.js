import{t as e}from"./wii-DFanSMW3.js";import"./widev-Czq8ue36.js";import{n as t}from"./vendor-Dkcx8wGc.js";import{r as n}from"./index-U_klNYw1.js";var r=()=>`
<div class="dc_wrap">
...
`,i=null,a=()=>{i=new IntersectionObserver(e=>e.forEach(e=>{e.isIntersecting&&t(e.target).addClass(`visible`)}),{threshold:.1}),t(`.wi_fadeUp`).each(function(){i.observe(this)}),t(document).on(`click.descubre`,`.nv_item`,function(e){let r=t(this).attr(`href`);r&&r.startsWith(`/`)&&(e.preventDefault(),n(()=>import(`./index-U_klNYw1.js`).then(e=>e.rutas.navigate(r)),[]))}),console.log(`🧭 ${e} Descubre cargado`),window.__WIREADY__=!0},o=()=>{i?.disconnect?.(),i=null,t(document).off(`.descubre`)};export{o as cleanup,a as init,r as render};