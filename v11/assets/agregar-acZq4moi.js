import{n as e}from"./vendor-BBPjS4yS.js";import{S as t,d as n,i as r,w as i}from"./widev-0VNtC2h-.js";import{M as a,O as o,T as s,_ as c,k as l,m as u,p as d,x as f}from"./firebase-37FTGmWc.js";import{n as p,t as m}from"./firebase-83wos_3H.js";var h=`wiAudios`,g=`wiImg`,_=()=>n(`wiSmile`)?.email||m.currentUser?.email||``,v=async e=>{let t=_();return t?(await c(f(o(p,e),s(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await d(o(p,e),{email:r,titulo:t,src:n,creado:a(),actualizado:a()})).id:null},b=async(e,t)=>{await u(l(p,e,t))},x=()=>v(h),S=()=>v(g),C=(e,t)=>`
