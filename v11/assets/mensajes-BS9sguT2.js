import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DRdy2sPR.js";import{E as n,a as r,d as i,i as a,w as o}from"./widev-0VNtC2h-.js";import{n as s}from"./index-kLqLg-A_.js";import{M as c,O as l,S as u,T as d,_ as f,k as p,m,v as h,x as g}from"./firebase-37FTGmWc.js";import{n as _,t as v}from"./firebase-83wos_3H.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>i(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
