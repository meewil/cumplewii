import{n as e}from"./vendor-BBPjS4yS.js";import{i as t,t as n}from"./wii-DRdy2sPR.js";import{E as r,_ as i,d as a,g as o,h as s,i as c,w as l,x as u}from"./widev-0VNtC2h-.js";import{r as d}from"./index-kLqLg-A_.js";import{c as f,f as p,m,n as h,o as g,p as _,r as v,s as y,u as b,v as x,y as S}from"./devblog-Dt2qp9Re.js";e(`#wiad_styles`).length||e(`<style id="wiad_styles">`).text(`
...
`,w=e=>`<a href="/${e.slug||e.id}" class="po_rel_card" ${l(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-calendar"></i> ${x(e.actualizado||e.creado)} · <i class="fas fa-eye"></i> ${e.vistas||0} · <i class="fas fa-heart" style="color:#fe0149"></i> ${e.likes||0}</span></div></a>`,T=(e,t,n=`po_fade po_visible`)=>e||t?`
    ...
    <aside class="po_sidebar">
      <div class="po_side_card ${u}" style="--d:.15s">
        ...
        <div class="po_autor_box"><div class="po_autor_av"><img src="/cumplewii/v11/smile.avif" alt="${e.autor}"/></div><div class="po_autor_info"><strong>${e.autor}</strong><span>${n} <i class="fas ${t}"></i></span></div></div>
