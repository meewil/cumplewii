...
</div>`,x=()=>{let e=0,i=t(`.ini_role`),a=setInterval(()=>{i.removeClass(`active`),i.eq(e=(e+1)%i.length).addClass(`active`)},2800);r(`#in_stats`,()=>{t(`.ini_stat_n`).each(function(){let e=t(this),n=+e.data(`target`),r=e.data(`sufijo`)||``,i=0,a=setInterval(()=>{i+=n/50,i>=n?(e.text(n+r),clearInterval(a)):e.text(Math.floor(i))},28)})}),r(`.ini_cat_card`,null,{anim:`wi_fadeUp`,stagger:80}),r(`.ini_about_card`,null,{anim:`wi_fadeUp`,stagger:140});let o=new Date(new Date().getTime()+7200*60*1e3),s=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,`0`)}-${String(o.getDate()).padStart(2,`0`)}`;t(`#widget_input_fecha`).val(s);let c=()=>{let e=t(`#widget_input_fecha`).val();if(!e)return;let n=e.split(`-`),r=new Date(n[0],n[1]-1,n[2]),i=new Date;r<i&&r.setFullYear(i.getFullYear()+ +(r.getMonth()<i.getMonth()||r.getMonth()===i.getMonth()&&r.getDate()<i.getDate()));let a=r.getTime()-i.getTime();if(a<=0){t(`#wd_dias`).text(0),t(`#wd_horas`).text(0),t(`#wd_mins`).text(0),t(`#wd_segs`).text(0);return}let o=Math.floor(a/(1e3*60*60*24)),s=Math.floor(a%(1e3*60*60*24)/(1e3*60*60)),c=Math.floor(a%(1e3*60*60)/(1e3*60)),l=Math.floor(a%(1e3*60)/1e3);t(`#wd_dias`).text(o),t(`#wd_horas`).text(s),t(`#wd_mins`).text(c),t(`#wd_segs`).text(l)};t(`#widget_input_nombre`).on(`input`,function(){let e=t(this).val().trim()||`Alguien especial`;t(`#widget_nombre`).html(`🎂 ¡${e}! 🥳`)}),t(`#widget_input_fecha`).on(`change`,()=>{c()}),c(),y=setInterval(c,1e3),window._inicio_timers=[a,y],console.log(`🚀 ${n} v10 · Inicio CumpleWii OK`)},S=()=>{window._inicio_timers&&window._inicio_timers.forEach(e=>clearInterval(e)),clearInterval(y)},C=(function(){let e=typeof document<`u`&&document.createElement(`link`).relList;return e&&e.supports&&e.supports(`modulepreload`)?`modulepreload`:`preload`})(),w=function(e){return`/cumplewii/v11/`+e},T={},E=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=w(t,n),t in T)return;T[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:C,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},D=[],O={todos:{nvleft:[{href:`/`,page:`inicio`,ico:`fa-house`,txt:`Bienvenido`},{href:`/descubre`,page:`descubre`,ico:`fa-compass`,txt:`Descubre`},{href:`/privacidad`,page:`privacidad`,ico:`fa-user-shield`,txt:`Privacidad`},{href:`/terminos`,page:`terminos`,ico:`fa-file-contract`,txt:`Términos`},{href:`/acerca`,page:`acerca`,ico:`fa-circle-info`,txt:`Acerca`},...D],nvright:[]},smile:{nvleft:[{href:`/registrar`,page:`registrar`,ico:`fa-plus-circle`,txt:`Registrar Ventas`},{href:`/historial`,page:`historial`,ico:`fa-clipboard-list`,txt:`Historial Ventas`},{href:`/ranking`,page:`ranking`,ico:`fa-trophy`,txt:`Ranking`},{href:`/tours`,page:`tours`,ico:`fa-route`,txt:`Tours `},{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`},...D],nvright:[{isPerfil:!0},{isSalir:!0}]},gestor:{nvleft:[{href:`/gestor`,page:`gestor`,ico:`fa-house`,txt:`Dashboard`},{href:`/registrar`,page:`registrar`,ico:`fa-plus-circle`,txt:`Registrar Ventas`},{href:`/ranking`,page:`ranking`,ico:`fa-trophy`,txt:`Ranking`},{href:`/historial`,page:`historial`,ico:`fa-clipboard-list`,txt:`Tablero`},{href:`/tours`,page:`tours`,ico:`fa-route`,txt:`Tours`},{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`},...D],nvright:[{href:`/rrhh`,page:`rrhh`,ico:`fa-users-gear`,txt:`RRHH`},{href:`/precios`,page:`precios`,ico:`fa-tags`,txt:`Precios`},{isPerfil:!0},{isSalir:!0}]},admin:{nvleft:[{href:`/admin`,page:`admin`,ico:`fa-globe`,txt:`Plataforma`},{href:`/usuarios`,page:`usuarios`,ico:`fa-users`,txt:`Usuarios`},{href:`/permisos`,page:`permisos`,ico:`fa-lock`,txt:`Permisos`},{href:`/sistema`,page:`sistema`,ico:`fa-cogs`,txt:`Sistema`},{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`}],nvright:[{href:`/mifcm`,page:`mifcm`,ico:`fa-bell`,txt:`Mi FCM`},{href:`/word`,page:`word`,ico:`fa-rocket`,txt:`Planificar`},{href:`/nuevo`,page:`nuevo`,ico:`fa-plus`,txt:`Post`},{href:`/notas`,page:`notas`,ico:`fa-comments`,txt:`Book`},{isPerfil:!0},{isSalir:!0}]},verificar:{nvleft:[],nvright:[]}},k=[{path:`/inicio`,area:`web/`},{path:`/login`,area:`web/`},{path:`/emojis`,area:`web/`},{path:`/registrado`,area:`web/`},{path:`/blog`,area:`web/blog/`},{path:`/post`,area:`web/blog/`},{path:`/chatwil`,area:`web/chatwil/`},{path:`/acerca`,area:`web/acerca/`},{path:`/descubre`,area:`web/acerca/`},{path:`/terminos`,area:`web/acerca/`},{path:`/cookies`,area:`web/acerca/`},{path:`/privacidad`,area:`web/acerca/`},{path:`/feedback`,area:`web/acerca/`},{path:`/contacto`,area:`web/acerca/`},{path:`/agregar`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/smile`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/notas`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/perfil`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/mensajes`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/word`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/nuevo`,area:`web/blog/`,roles:[`smile`,`gestor`,`admin`]},{path:`/registrar`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/ranking`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/historial`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/tours`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/avisar`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/chat`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/rrhh`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/precios`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/gestor`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/admin`,area:`admin/`,roles:[`admin`]},{path:`/usuarios`,area:`admin/`,roles:[`admin`]},{path:`/permisos`,area:`admin/`,roles:[`admin`]},{path:`/sistema`,area:`admin/`,roles:[`admin`]},{path:`/mifcm`,area:`admin/`,roles:[`admin`]},{path:`/verificar`,area:`verificar/`,roles:[`admin`]}],A=Object.assign({"./admin/admin.js":()=>E(()=>import(`./admin-Cco91lP3.js`),__vite__mapDeps([0])),"./admin/fcm.js":()=>E(()=>import(`./fcm-Bs8gsFCf.js`),[]),"./admin/mifcm.js":()=>E(()=>import(`./mifcm-DqsD1mMz.js`),__vite__mapDeps([1])),"./admin/permisos.js":()=>E(()=>import(`./permisos-B0Z5q9tB.js`),__vite__mapDeps([2])),"./admin/sistema.js":()=>E(()=>import(`./sistema-Bd8W6Nxr.js`),__vite__mapDeps([3])),"./admin/usuarios.js":()=>E(()=>import(`./usuarios-BCgw2QNW.js`),__vite__mapDeps([4])),"./gestor/gestor.js":()=>E(()=>import(`./gestor-OypiMmyL.js`),[]),"./gestor/precios.js":()=>E(()=>import(`./precios-CdeFGIqi.js`),__vite__mapDeps([5])),"./gestor/rrhh.js":()=>E(()=>import(`./rrhh-DQYMreQH.js`),__vite__mapDeps([6])),"./gestor/trabajadores.js":()=>E(()=>import(`./trabajadores-KYHHSMef.js`),[]),"./smile/agregar.js":()=>E(()=>import(`./agregar-acZq4moi.js`),__vite__mapDeps([7])),"./smile/avisar.js":()=>E(()=>import(`./avisar-B8wZF3Co.js`),__vite__mapDeps([8])),"./smile/chat.js":()=>E(()=>import(`./chat-C4tIdZNm.js`),__vite__mapDeps([9])),"./smile/crear.js":()=>E(()=>import(`./crear-CumHfFfT.js`),__vite__mapDeps([10])),"./smile/historial.js":()=>E(()=>import(`./historial-WWN4Zr0c.js`),__vite__mapDeps([11])),"./smile/mensajes.js":()=>E(()=>import(`./mensajes-BS9sguT2.js`),__vite__mapDeps([12])),"./smile/metricas.js":()=>E(()=>import(`./metricas-BuxxBwQu.js`),__vite__mapDeps([13])),"./smile/notas.js":()=>E(()=>import(`./notas-CRIbs-Xw.js`),__vite__mapDeps([14])),"./smile/perfil.js":()=>E(()=>import(`./perfil-pZTqGuEb.js`),__vite__mapDeps([15])),"./smile/ranking.js":()=>E(()=>import(`./ranking-DVk7CHBy.js`),__vite__mapDeps([16])),"./smile/registrar.js":()=>E(()=>import(`./registrar-CpPgQm6T.js`),__vite__mapDeps([17])),"./smile/smile.js":()=>E(()=>import(`./smile-DfKHQ-RM.js`),__vite__mapDeps([18])),"./smile/tours.js":()=>E(()=>import(`./tours-BTEclLuZ.js`),__vite__mapDeps([19])),"./smile/win.js":()=>E(()=>import(`./win-BPNEiDPr.js`),__vite__mapDeps([20])),"./smile/word.js":()=>E(()=>import(`./word-B4C0VdZc.js`),__vite__mapDeps([21])),"./smile/zsmile.js":()=>E(()=>import(`./zsmile-DqGouJmF.js`),[]),"./verificar/verificar.js":()=>E(()=>import(`./verificar-BPJruyzD.js`),__vite__mapDeps([22])),"./web/404.js":()=>E(()=>import(`./404-OlTui3V7.js`),[]),"./web/acerca/acerca.js":()=>E(()=>import(`./acerca-DW_YE2bA.js`),__vite__mapDeps([23])),"./web/acerca/contacto.js":()=>E(()=>import(`./contacto-B0jfXEbh.js`),__vite__mapDeps([23,24])),"./web/acerca/cookies.js":()=>E(()=>import(`./cookies-Dacdkmwu.js`),__vite__mapDeps([23,25])),"./web/acerca/descubre.js":()=>E(()=>import(`./descubre-CH9c-QWC.js`),__vite__mapDeps([26])),"./web/acerca/feedback.js":()=>E(()=>import(`./feedback-DYBMFpzL.js`),__vite__mapDeps([23,25])),"./web/acerca/privacidad.js":()=>E(()=>import(`./privacidad-BMwk0JWh.js`),__vite__mapDeps([23,25])),"./web/acerca/terminos.js":()=>E(()=>import(`./terminos-B0VeLtEy.js`),__vite__mapDeps([23,25])),"./web/blog/blog.js":()=>E(()=>import(`./blog-YJfVI0WI.js`),__vite__mapDeps([27])),"./web/blog/nuevo.js":()=>E(()=>import(`./nuevo-5hi4VmY4.js`),__vite__mapDeps([28])),"./web/blog/post.js":()=>E(()=>import(`./post-BVa09bZ7.js`),__vite__mapDeps([29])),"./web/blog/woo.js":()=>E(()=>import(`./woo-DzoyYbJ8.js`),[]),"./web/chatwil/chatwil.js":()=>E(()=>import(`./chatwil-B0oZMf5Z.js`),__vite__mapDeps([30])),"./web/chatwil/config.js":()=>E(()=>import(`./config-CueSkq2Q.js`),[]),"./web/chatwil/contexto.js":()=>E(()=>import(`./contexto-CTYUHjOZ.js`),[]),"./web/chatwil/datawii.js":()=>E(()=>import(`./datawii-MGnarJp0.js`),[]),"./web/chatwil/waa.js":()=>E(()=>import(`./waa-BSRlNFQl.js`),[]),"./web/emojis.js":()=>E(()=>import(`./emojis-ot2Of4rU.js`),__vite__mapDeps([31])),"./web/login.js":()=>E(()=>import(`./login-D2o4210n.js`),__vite__mapDeps([32])),"./web/precios.js":()=>E(()=>import(`./precios-Cy1ouycp.js`),__vite__mapDeps([33])),"./web/registrado.js":()=>E(()=>import(`./registrado-W2tsZzDz.js`),__vite__mapDeps([34]))}),j=(e,t)=>A[`./${e}${t}.js`],M=new class{constructor(){this.rutas={},this.cache={"/inicio":d},this.modActual=null,this.cargand=!1,this.HOME=`inicio`,this.main=`#wimain`,this.pathActual=null,this.isFirstLoad=!0}register(e,t){this.rutas[e]=t}inicio(){return Promise.resolve(d)}registerAll(e){let t={},n={};k.forEach(({path:e,area:r,roles:i=null,mod:a})=>{if(e===`/inicio`){t[e]=()=>this.inicio();return}let o=a??e.split(`/`).pop(),s=j(r,o);if(!s){console.warn(`[ruta] no encontrado: ${r}${o}.js`);return}i===null?t[e]=s:(n[e]??=[]).push({roles:i,imp:s})});let r=()=>Promise.resolve({render:()=>``,init:()=>setTimeout(()=>this.navigate(`/login`),0)});new Set([...Object.keys(t),...Object.keys(n)]).forEach(i=>{let a=t[i],o=n[i]||[],s=()=>{let t=e?.()||null;return o.find(e=>e.roles.includes(t))};if(!o.length)return this.register(i,a);if(!a)return this.register(i,()=>{let e=s();return e?e.imp():r()});this.register(i,()=>{let e=s();return e?e.imp():a()})})}async prefetch(e){let t=a.limpiar(e)===`/`?`/${this.HOME}`:a.limpiar(e);if(!(this.cache[t]||!this.rutas[t]))try{this.cache[t]=await this.rutas[t](),console.log(`⚡ Listo ${t.replace(`/`,``)}`)}catch{console.warn(`[ruta] prefetch falló:`,t)}}async navigate(e,n=!0){if(this.cargand)return;this.cargand=!0;let r=a.limpiar(e)===`/`?`/${this.HOME}`:a.limpiar(e);if([`/admin`,`/usuarios`,`/permisos`,`/sistema`,`/mifcm`].includes(r)){let{getls:e}=await E(async()=>{let{getls:e}=await import(`./widev-0VNtC2h-.js`).then(e=>e.D);return{getls:e}},[]),t=e(`wiSmile`),n=e=>(this.cargand=!1,this.navigate(e,!0)),r=!t||t.rol!==`admin`?`/`:t.estado===`activo`?sessionStorage.getItem(`vault_unlocked`)?null:`/verificar`:`/registrado`;if(r)return n(r)}try{this.modActual?.cleanup?.();let e=this.rutas[r]?null:r.slice(1),i=e?j(`web/blog/`,`post`):this.rutas[r]??j(`web/`,`404`),o=this.cache[r]??await i();e||(this.cache[r]=o);let[s]=await Promise.all([o.render(e)]);document.body.classList.remove(`is-public-profile`),this.marcarNav(r),window.dispatchEvent(new CustomEvent(`winavigate`,{detail:{norm:r}})),this.isFirstLoad&&t(this.main).children().length>0&&!window.__WIREADY__&&r===`/${this.HOME}`?this.isFirstLoad=!1:await u(this.main,s),this.isFirstLoad=!1,window.scrollTo(0,0),o.init?.(e),n&&a.poner(r===`/${this.HOME}`?`/`:r,document.title),this.pathActual=r,this.modActual=o}catch(e){if(e instanceof TypeError&&e.message.includes(`Failed to fetch`))return location.reload();s(`Error en la ruta`),console.error(`[ruta] navigate:`,e)}finally{this.cargand=!1}}marcarNav(e){let n=e.slice(1)||this.HOME;t(`.nv_item`).removeClass(`active`),t(`.nv_item[data-page="${n}"]`).addClass(`active`)}init(){this.marcarNav(a.actual===`/`?`/${this.HOME}`:a.limpiar(a.actual)),t(document).on(`click`,`.nv_item`,e=>{e.preventDefault();let n=t(e.currentTarget).data(`page`);this.navigate(n===this.HOME?`/`:`/${n}`)}).on(`mouseenter touchstart`,`.nv_item[data-page]`,e=>{let n=t(e.currentTarget).data(`page`);this.prefetch(n===this.HOME?`/`:`/${n}`)}),window.addEventListener(`popstate`,e=>{let t=e.state?.ruta||a.actual;(a.limpiar(t)===`/`?`/${this.HOME}`:a.limpiar(t))!==this.pathActual&&this.navigate(t,!1)}),this.navigate(a.actual,!1)}};M.registerAll(()=>o(`wiSmile`)?.rol),M.register(`/`,(e=!1)=>{let t=o(`wiSmile`);return t&&!e&&setTimeout(()=>M.navigate({smile:`/smile`,gestor:`/gestor`,admin:`/admin`}[t.rol]||`/smile`),0),M.inicio()}),M.init(),E(()=>import(`./header-epaXLBhy.js`),[]),E(()=>import(`./footer-D0RbOUu4.js`),[]),l({css:[`https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap`,`https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&display=swap`,`https://fonts.googleapis.com/css2?family=Rubik:wght@300..900&display=swap`]});export{M as n,E as r,O as t};