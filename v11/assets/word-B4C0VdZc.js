import{n as e}from"./vendor-BBPjS4yS.js";import{t}from"./wii-DRdy2sPR.js";import{C as n,_ as r,a as i,d as a,g as o,i as s,l as c,m as l,w as u,y as d}from"./widev-0VNtC2h-.js";import{r as f}from"./index-kLqLg-A_.js";var p=`word_docs`,m=()=>`wd`+Date.now(),h=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],g={get:()=>{let e=localStorage.getItem(p);return e===null&&!r.user?[...h]:a(p)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>l(p,e,8760)},_=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
